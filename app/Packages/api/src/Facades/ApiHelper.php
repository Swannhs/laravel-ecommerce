...
namespace App\Packages\Api\Facades;

use App\Packages\Api\Supports\ApiHelper as ApiHelperSupport;
use Illuminate\Support\Facades\Facade;

/**
 * @method static string modelName()
 * @method static \App\Packages\Api\Supports\ApiHelper setModelName(string $modelName)
 ...
 *
 * @see \App\Packages\Api\Supports\ApiHelper
 */
