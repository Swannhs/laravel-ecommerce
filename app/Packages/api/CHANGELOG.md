...
All notable changes to `platformcore/git-commit-checker` will be documented in this file.
...
- Fix output render on Windows platform (https://github.com/platformcore/git-commit-checker/pull/10)
