...
namespace App\Packages\DataSynchronize\Exporter;

use App\Core\Base\Facades\Assets;
use App\Core\Base\Facades\BaseHelper;
use App\Packages\DataSynchronize\Concerns\Exporter\HasEmptyState;
use App\Packages\DataSynchronize\Enums\ExportColumnType;
use Carbon\Carbon;
...
abstract class Exporter implements FromCollection, ShouldAutoSize, WithColumnFormatting, WithEvents, WithHeadings, WithMapping
{
    ...
    /**
     * @return \App\Packages\DataSynchronize\Exporter\ExportColumn[]
     */
    ...
    /**
     * @return \App\Packages\DataSynchronize\Exporter\ExportCounter[]
     */
