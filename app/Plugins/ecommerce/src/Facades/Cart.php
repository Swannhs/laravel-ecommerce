...
use App\Plugins\Ecommerce\Cart\Cart as BaseCart;
use Illuminate\Support\Facades\Facade;

/**
 * @method static \App\Plugins\Ecommerce\Cart\Cart instance(string|null $instance = null)
 ...
 * @method static \App\Plugins\Ecommerce\Cart\CartItem|bool|null update(string $rowId, \App\Plugins\Ecommerce\Cart\Contracts\Buyable|array|int $qty)
 * @method static mixed updateQuietly($rowId, $qty)
 * @method static \App\Plugins\Ecommerce\Cart\CartItem|null get(string $rowId)
 ...
 * @method static void associate(string $rowId, \App\Core\Base\Models\BaseModel|string $model)
 ...
 *
 * @see \App\Plugins\Ecommerce\Cart\Cart
 */
