...
class ReviewSeeder extends BaseSeeder
{
    public function run(): void
    {
        ...
        $reviews = [
            ...
            'This web app is really good in design, code quality & features. Besides, the customer support provided by the PlatformCore team was really fast & helpful. You guys are awesome!',
            ...
            'I Love this Script. I also found how to add other fees. Now I just wait the BIG update for the Marketplace with the Bulk Import. Just do not forget to make it to be Multi-language for us the PlatformCore Fans.',
            'The best ecommerce CMS! Excellent coding! best support service! Thank you so much..... I really like your hard work.',
            'Second or third time that I buy a PlatformCore product, happy with the products and support. You guys do a good job :)',
            ...
            'Perfect +++++++++ i love it really also i get to fast ticket answers... Thanks Lot PlatformCore Teams',
            'The code is good, in general, if you like it, can you give it 5 stars?',
            'Great system, great support, good job PlatformCore. I\'m looking forward to more great functional plugins.',
            'Good app, good backup service and support. Good documentation.',
            'Clean & perfect source code',
            'Best ecommerce CMS online store!',
            'Amazing code, amazing support. Overall, im really confident in PlatformCore and im happy I made the right choice! Thank you so much guys for coding this masterpiece',
