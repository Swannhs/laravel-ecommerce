...
use App\Plugins\Marketplace\Http\Controllers\VendorBlockedController;
use App\Plugins\Marketplace\Http\Controllers\WithdrawalInvoiceController;
use Illuminate\Support\Facades\Route;

AdminHelper::registerRoutes(function (): void {
    Route::group(['namespace' => 'App\Plugins\Marketplace\Http\Controllers'], function (): void {
